( () => {
    var t = {
        646: t => {
            ...
            l.prototype.eventNames = function() {
                ...
                if (0 === this._eventsCount)
                    return s;
                for (o in t = this._events)
                    e.call(t, o) && s.push(i ? o.slice(1) : o);
            ...
            l.prototype.listeners = function(t) {
                ...
                if (o.fn)
                    return [o.fn];
                for (var s = 0, n = o.length, r = new Array(n); s < n; s++)
                    r[s] = o[s].fn;
                return r
            }
            ,
            ...
            ,
            l.prototype.emit = function(t, e, o, s, n, r) {
                var l = i ? i + t : t;
                if (!this._events[l])
                    return !1;
                var a, d, c = this._events[l], p = arguments.length;
                if (c.fn) {
                    ...
                    case 2:
                        ...
                        !0;
                    case 3:
                        return c.fn.call(c.context, e, o),
                        !0;
                    case 4:
                        return c.fn.call(c.context, e, o, s),
                        !0;
                    case 5:
                        return c.fn.call(c.context, e, o, s, n),
                        !0;
                    case 6:
                        return c.fn.call(c.context, e, o, s, n, r),
                        !0
                    }
                    for (d = 1,
                    a = new Array(p - 1); d < p; d++)
                        a[d - 1] = arguments[d];
                    c.fn.apply(c.context, a)
                } else {
                    var u, f = c.length;
                    for (d = 0; d < f; d++)
                        switch (c[d].once && this.removeListener(t, c[d].fn, void 0, !0),
                        p) {
                        case 1:
                            c[d].fn.call(c[d].context);
                            break;
                        case 2:
                            c[d].fn.call(c[d].context, e);
                            break;
                        case 3:
                            c[d].fn.call(c[d].context, e, o);
                            break;
                        case 4:
                            c[d].fn.call(c[d].context, e, o, s);
                            break;
                        default:
                            if (!a)
                                for (u = 1,
                                a = new Array(p - 1); u < p; u++)
                                    a[u - 1] = arguments[u];
                            c[d].fn.apply(c[d].context, a)
                        }
                }
                return !0
            }
            ...
            ,
            l.prototype.removeListener = function(t, e, o, s) {
                var n = i ? i + t : t;
                if (!this._events[n])
                    return this;
                if (!e)
                ...
                if (l.fn)
                    l.fn !== e || s && !l.once || o && l.context !== o || r(this, n);
                else {
                    for (var a = 0, d = [], c = l.length; a < c; a++)
                        (l[a].fn !== e || s && !l[a].once || o && l[a].context !== o) && d.push(l[a]);
                    d.length ? this._events[n] = 1 === d.length ? d[0] : d : r(this, n)
                }
                return this
            }
            ,
            l.prototype.removeAllListeners = function(t) {
                var e;
                return t ? (e = i ? i + t : t,
                this._events[e] && r(this, e)) : (this._events = new o,
                this._eventsCount = 0),
                this
            }
            ,
        ...
        ,
        960: t => {
            t.exports = '<div class="boldgrid-section boldgrid-tabs-pane" id=home role=tabpanel aria-labelledby=home-tab> <div class=container> <div class=row> <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <p></p> </div> </div> </div> </div> '
        }
        ,
        920: t => {
            t.exports = "<li class=nav-item role=presentation> <button class=nav-link id=home-tab data-bgtab-target=#home role=tab>Tab</button> </li> "
        }
        ,
        385: (t, e, i) => {
            var o, s, n;
            !function(r) {
                ...
                o = function(t) {
                    ...
                    i.prototype.addSlide = i.prototype.slickAdd = function(e, i, o) {
                        ...
                        if ("boolean" == typeof i)
                            ...
                            return !1;
                        s.unload(),
                        "number" == typeof i ? 0 === i && 0 === s.$slides.length ? t(e).appendTo(s.$slideTrack) : o ? t(e).insertBefore(s.$slides.eq(i)) : t(e).insertAfter(s.$slides.eq(i)) : !0 === o ? t(e).prependTo(s.$slideTrack) : t(e).appendTo(s.$slideTrack),
                    ...
                    i.prototype.animateSlide = function(e, i) {
                        ...
                        t({
                            ...
                            step: function(t) {
                                t = Math.ceil(t),
                                !1 === s.options.vertical ? (o[s.animType] = "translate(" + t + "px, 0px)",
                    ...
                    i.prototype.changeSlide = function(e, i) {
                        var o, s, n = this, r = t(e.currentTarget);
                    ...
                    i.prototype.lazyLoad = function() {
                        ...
                        "anticipated" === s.options.lazyLoad)
                            for (var r = i - 1, l = o, a = s.$slider.find(".slick-slide"), d = 0; d < s.options.slidesToScroll; d++)
                    ...
                    i.prototype.progressiveLazyLoad = function(e) {
                        e = e || 1;
                        var i, o, s, n, r, l = this, a = t("img[data-lazy]", l.$slider);
                        a.length ? (i = a.first(),
                        o = i.attr("data-lazy"),
                    ...
                    i.prototype.registerBreakpoints = function() {
                        var e, i, o, s = this, n = s.options.responsive || null;
                    ...
                    i.prototype.setCSS = function(t) {
                        ...
                        !1 === o.cssTransitions ? (s[o.animType] = "translate(" + e + ", " + i + ")",
                    ...
                    i.prototype.setSlideClasses = function(t) {
                        ...
                        !0 === n.options.centerMode) {
                            ...
                            !0 === n.options.infinite && (t >= e && t <= n.slideCount - 1 - e ? n.$slides.slice(t - e + r, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + t,
                            ...
                            t >= 0 && t <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(t, t + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : i.length <= n.options.slidesToShow ? i.addClass("slick-active").attr("aria-hidden", "false") : (s = n.slideCount % n.options.slidesToShow,
                            o = !0 === n.options.infinite ? n.options.slidesToShow + t : t,
                            n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - t < n.options.slidesToShow ? i.slice(o - (n.options.slidesToShow - s), o + s).addClass("slick-active").attr("aria-hidden", "false") : i.slice(o, o + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
                    ...
                    i.prototype.swipeMove = function(t) {
                        ...
                        i = l.swipeDirection(),
                        void 0 !== t.originalEvent && l.touchObject.swipeLength > 4 && (l.swiping = !0,
                        t.preventDefault()),
                    ...
                    t.fn.slick = function() {
                        ...
                        for (t = 0; t < r; t++)
                            if ("object" == typeof s || void 0 === s ? o[t].slick = new i(o[t],s) : e = o[t].slick[s].apply(o[t].slick, n),
                            void 0 !== e)
                                return e;
                        return o
                    }
                ...
                ,
                void 0 === (n = o.apply(e, s)) || (t.exports = n)
            }()
        }
        ,
        669: t => {
    ...
    ( () => {
        ...
        function n(t) {
            for (var e = 1; e < arguments.length; e++) {
                ...
                e % 2 ? s(Object(i), !0).forEach((function(e) {
                    ...
                    s = e,
                    n = i[e],
                    (s = l(s))in o ? Object.defineProperty(o, s, {
                        value: n,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        var a = i(669)
          , d = function() {
            ...
            (i = [{
                ...
                key: "getArrowHtml",
                value: function(t, e) {
                    return '<button type="button" class="slick-'.concat("left" === t ? "prev" : "next", ' slick-arrow">\n\t\t\t<span class="fa fa-').concat(e, "-").concat(t, '" aria-hidden="true"></span></button>')
                }
            }, {
                key: "initPageSliders",
                value: function() {
                    this._setupWowJs(),
                    this.initSlider(a(".boldgrid-slider"))
                }
            }, {
                key: "resizeSliders",
                value: function(t) {
                    var e = this;
                    t.find(".boldgrid-slider").each((function(t, i) {
                        var o = a(i);
                        i.slick ? o.slick("setPosition") : e.initSlider(o)
                    }
                    ))
                }
            }, {
                ...
                value: function(t) {
                    ...
                    t.each((function(t, i) {
                        var o, s = a(i);
                        s.hasClass("slick-initialized") && e.revertHTML(s),
                        (o = e.parseConfig(s)).autoplaySpeed = o.autoplaySpeed ? 1e3 * parseInt(o.autoplaySpeed, 10) : 1e4,
                        (o = n(n({}, e.defaults), o)).autoplay = !e.isEditor() && o.autoplay,
                        o.swipe = !e.isEditor() && o.swipe,
                        s.toggleClass("slick-arrow-overlay", o.bgOptions.arrowsOverlay),
                        s.attr("arrow-location", o.arrows ? o.bgOptions.arrowsPos : ""),
                        s.toggleClass("slick-dots-overlay", o.bgOptions.dotsOverlay),
                        s.attr("dots-location", o.dots ? o.bgOptions.dotsPos : ""),
                        o.prevArrow = e.getArrowHtml("left", o.bgOptions.arrowsIcon),
                        o.nextArrow = e.getArrowHtml("right", o.bgOptions.arrowsIcon),
                        s.slick(o),
                        s.find(".slick-arrow").css("font-size", "".concat(o.bgOptions.arrowsSize, "px")),
                        s.find(".slick-dots").css("font-size", "".concat(o.bgOptions.dotsSize, "px")),
                        s.find(".slick-dots button").empty(),
                        s.off("afterChange.ppbp"),
                        s.on("afterChange.ppbp", (function() {
                            return e.event.emit("slideChange", s)
                        }
                        )),
                        e._applyColors(s, o),
                        e._calcMargin(s, o),
                        e._calcPadding(s, o),
                        e.event.emit("initialized", s)
                    }
                    ))
                }
            }, {
                key: "parseConfig",
                value: function(t) {
                    return JSON.parse(t.attr("data-config") || "{}") || this.defaults
                }
            }, {
                key: "revertHTML",
                value: function(t) {
                    var e = ""
                      , i = this.getSlideClass(t);
                    t.hasClass("slick-initialized") && (t.find(".slick-slide:not(.slick-cloned) .".concat(i)).each((function(t, i) {
                        e += i.outerHTML
                    }
                    )),
                    t.html(e)),
                    t.removeAttr("arrow-location").removeAttr("dots-location"),
                    t.removeClass("slick-initialized slick-slider slick-arrow-overlay slick-dotted")
                }
            }, {
                key: "getSlideClass",
                value: function(t) {
                    return t.hasClass("boldgrid-wrap-row") ? "row" : "boldgrid-section"
                }
            }, {
                key: "_setupWowJs",
                value: function() {
                    BOLDGRID.PPB && BOLDGRID.PPB.wowJs && (this.event.on("initialized", (function(t) {
                        t.find(".slick-current .wow").each((function(t, e) {
                            e.animated = !0
                        }
                        ))
                    }
                    )),
                    this.event.on("slideChange", (function(t) {
                        t.find(".slick-current .wow").each((function(e, i) {
                            !i.animated && BOLDGRID.PPB.wowJs.isVisible(i) && (i.animated = !0,
                            t.find(".wow").css({
                                visibility: "",
                                "animation-name": "none"
                            }).removeClass("animated"),
                            BOLDGRID.PPB.wowJs.boxes.push(i),
                            BOLDGRID.PPB.wowJs.scrolled = !0,
                        ...
                        try {
                            for (s.s(); !(i = s.n()).done; ) {
                                ...
                                if (e.colors[n.name]) {
                                    ...
                                    "background-color" === n.type ? this._applyBGColor(e.colors[n.name], r) : this._applyColor(e.colors[n.name], n.type, r)
                                }
                            }
                        } catch (t) {
                            s.e(t)
                ...
                key: "_applyBGColor",
                value: function(t, e) {
                    "class" === t.type ? e.addClass("color".concat(t.value, "-background-color color-").concat(t.value, "-text-contrast")) : e.css({
                ...
                value: function(t, e, i) {
                    "class" === t.type ? i.addClass("color".concat(t.value, "-").concat(e)) : i.css(e, t.value)
                }
            }, {
                key: "_calcPadding",
                value: function(t, e) {
                    var i = t.find(".container, .container-fluid")
                      , o = {
                        paddingLeft: "",
                        paddingRight: ""
                    };
                    if (e.arrows && e.bgOptions.arrowsOverlay && -1 !== ["standard", "top", "bottom"].indexOf(e.bgOptions.arrowsPos)) {
                        var s = 1.2 * t.slick("getSlick").$nextArrow.outerWidth();
                        o = {
                            paddingLeft: s,
                            paddingRight: s
                        }
                ...
                value: function(t, e) {
                    if (t.css("margin-top", ""),
                    t.css("margin-bottom", ""),
                    e.arrows && !e.bgOptions.arrowsOverlay) {
                        var i, o = e.bgOptions.arrowsPos;
                        i = parseInt(e.bgOptions.arrowsSize, 10) + 20,
                        0 === o.indexOf("bottom") ? t.css("margin-bottom", "".concat(i, "px")) : 0 === o.indexOf("top") && t.css("margin-top", "".concat(i, "px"))
                    }
                }
            }]) && r(e.prototype, i),
        ...
        function g(t) {
            for (var e = 1; e < arguments.length; e++) {
                ...
                e % 2 ? y(Object(i), !0).forEach((function(e) {
                    ...
                    s = e,
                    n = i[e],
                    (s = w(s))in o ? Object.defineProperty(o, s, {
                        value: n,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
        ...
        var k = i(669)
          , m = function() {
            return e = function e() {
                ...
                var i = Math.floor(1e3 * Math.random() + 1)
                ...
                this.defaults = {
                    tabsList: [{
                        title: "Tab 1",
                        tabId: "tab-" + i,
                        target: "tab-" + i + "-content"
                    }, {
                        title: "Tab 2",
                        tabId: "tab-" + o,
                        target: "tab-" + o + "-content"
                    }, {
                        title: "Tab 3",
                        tabId: "tab-" + s,
            ...
            (i = [{
                key: "initPageTabs",
                value: function(t) {
                    var e = k(".boldgrid-tabs.boldgrid-section-wrap");
                    void 0 === t && "undefined" != typeof BG ? t = k(BG.mce.dom.doc) : void 0 === t && (t = k(document)),
                    t && t.hasClass("boldgrid-section-wrap") && (e = t),
                    0 === e.length && (e = t.find(".boldgrid-tabs.boldgrid-section-wrap")),
                    e.each((function(t, e) {
                        var i = k(e)
                          , o = i.find("ul.nav-tabs li.nav-item .nav-link");
                        o.off("click"),
                        o.on("click", (function(t) {
                            o.removeClass("active"),
                            t.preventDefault();
                            var e = k(t.currentTarget)
                              , s = i.find("#" + e.attr("data-bgtab-target"));
                            e.addClass("active"),
                            s.addClass("active"),
                            i.find(".boldgrid-tabs-pane").removeClass("active"),
                            s.addClass("active")
                        }
                        ))
                    }
                ...
                value: function(t) {
                    ...
                    t.each((function(t, i) {
                        var o, s = k(i);
                        s.hasClass("boldgrid-tabs") && (o = e.parseConfig(s),
                        o = g(g({}, e.defaults), o),
                        s.find("ul.nav-tabs").children().remove(),
                        o.tabsList && o.tabsList.forEach((function(t) {
                            var i = e.getSampleTab(p())
                              , o = i.find("button")
                              , n = e.getSampleTabContent(f())
                              , r = s.find("#" + t.target);
                            o.text(t.title),
                            o.attr("id", t.tabId),
                            o.attr("data-bgtab-target", t.target),
                            o.attr("contenteditable", "false"),
                            s.find("ul.nav-tabs").attr("contenteditable", "false"),
                            s.find("ul.nav-tabs").append(i),
                            0 === r.length && (n.find("div[class*=col-] p").text(t.title),
                            n.attr("id", t.target),
                            n.attr("aria-labelledby", t.tabId),
                            s.append(n))
                        }
                        )),
                        s.find("ul.nav-tabs").children().first().find("button").addClass("active"),
                        s.find(".boldgrid-tabs-pane").removeClass("active"),
                        s.find("#" + s.find("ul.nav-tabs li .active").attr("data-bgtab-target")).addClass("active"),
                        s.off("afterChange.ppbp"),
                        s.on("afterChange.ppbp", (function() {
                            return e.event.emit("tabsChange", s)
                        }
                        )),
                        e._applyColors(s, o),
                        e._calcPadding(s, o),
                ...
                key: "getAlignment",
                value: function(t) {
                    var e = t.find("ul.nav-tabs");
                    return e.hasClass("left-aligned") ? "left-aligned" : e.hasClass("right-aligned") ? "right-aligned" : "center"
                }
            }, {
                key: "setAlignment",
                value: function(t, e) {
                    var i = t.find("ul.nav-tabs");
                    i.removeClass("left-aligned right-aligned"),
                    "center" !== e && i.addClass(e)
                }
            }, {
                key: "addNewTab",
                value: function(t, e) {
                    var i = this.parseConfig(t);
                    i.tabsList.push(e),
                ...
                value: function(t, e) {
                    var i = this.parseConfig(t);
                    t.find("#" + e).remove(),
                    i.tabsList = i.tabsList.filter((function(t) {
                        return t.tabId !== e
                    }
                    )),
                    t.attr("data-config", JSON.stringify(i)),
                ...
                key: "onNodeChange",
                value: function(t) {
                    var e = k(BG.mce.selection.getNode())
                      , i = e.parents(".boldgrid-tabs.boldgrid-section-wrap")
                      , o = e.closest(".boldgrid-tabs-pane")
                      , s = e.parents(".boldgrid-tabs-section")
                      , n = i.find(".boldgrid-tabs-pane.active");
                    if (0 !== i.length && (0 !== s.length && BG.mce.selection.setCursorLocation(s.get(0), 0),
                    0 !== o.length && o.get(0) !== n.get(0))) {
                        var r = n.find("div[class*=row]").first()
                          , l = r.find("div[class*=col-]").first();
                        0 === r.length ? (n.html('<div class="container">\n\t\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t\t<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\t\t\t\t\t\t\t\t<p></p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>'),
                        BG.mce.selection.setCursorLocation(n.find("p").get(0), 0)) : 0 === l.length ? (n.html('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">\n\t\t\t\t\t\t<p></p>\n\t\t\t\t\t</div>'),
                        BG.mce.selection.setCursorLocation(n.find("p").get(0), 0)) : BG.mce.dom.isEmpty(l.get(0)) ? (l.append("<p></p>"),
                        BG.mce.selection.setCursorLocation(l.find("div[class*=col-]").get(0), 0)) : BG.mce.selection.setCursorLocation(l.children().get(0), 0)
                    }
                }
            }, {
                key: "onKeyDown",
                value: function(t) {
                    var e = k(BG.mce.selection.getNode());
                    if (0 !== e.parents(".boldgrid-tabs.boldgrid-section-wrap").length && ("8" == t.which || "46" == t.which) && BG.mce.dom.isEmpty(e[0])) {
                        var i = k('<p><br data-mce-bogus="1"></p>');
                        return e.after(i),
                        BG.mce.selection.setCursorLocation(i[0], 0),
                        !1
                    }
                }
            }, {
                    ...
                    if (e.colors) {
                        ...
                        try {
                            for (o.s(); !(i = o.n()).done; ) {
                                var s = i.value;
                                if (e.colors[s.name]) {
                                    var n = t.find(s.selector);
                                    "background-color" === s.type ? this._applyBGColor(e.colors[s.name], n) : this._applyColor(e.colors[s.name], s.type, n)
                                }
                            }
                        } catch (t) {
                            o.e(t)
                ...
                key: "_calcPadding",
                value: function(t, e) {
                    t.find(".container, .container-fluid").css({
                        paddingLeft: "",
                        paddingRight: ""
                    })
                }
        ...
        window.BOLDGRID.PPBP = (new x).init()
    }
    )()
}
)();
